...
- [x] Add profile-scoped left-stick vertical analog scrolling with deadzone/rate limiting.
...
- 2026-02-28: [DONE] Added profile-level left-stick vertical scroll (`analog.leftStickVerticalScroll`) with deadzone/speed/rate controls and enabled it for Ghostty.
