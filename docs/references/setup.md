...
- In Codex app, the profile keeps high-frequency text-entry, recent-viewed chat switching, archiving, and panel-toggle controls available without enabling Ghostty-only tab, split, or surface-management actions.
